...
import { usePrefs, useApplyPrefs } from "@/lib/prefs";
  ...
  head: () => ({
    meta: [
      ...
      { title: "SenseAll — Communication without barriers" },
      {
        name: "description",
        content:
          "An inclusive accessibility platform combining voice, Indian Sign Language, Braille and haptic feedback.",
      },
      { name: "author", content: "SenseAll" },
      { property: "og:title", content: "SenseAll — Communication without barriers" },
      {
        property: "og:description",
        content: "Voice, ISL, Braille and haptics in one accessible communication platform.",
      },
